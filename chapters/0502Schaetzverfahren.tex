...
\begin{figure}[H]
\begin{tabular}{cc}
\multicolumn{2}{c}{\subfloat[Fahrtverlauf (rot) bei einer Kurve (blau).]{\includegraphics[height=0.4\textheight,width=\textwidth]{/testlaeufe/gradeKurveSicht/auvroute.jpg}}}\\
...
\subfloat[Fehler der AUV Position zur echten Position des Objektes.]{\includegraphics[height=0.3\textheight,width=0.5\textwidth]{/testlaeufe/sinusSicht/groundTruthPosition.jpg}}&
