...
\begin{figure}[H]
\begin{tabular}{cc}
\multicolumn{2}{c}{\subfloat[Fahrtverlauf (rot) bei einer Kurve (blau).]{\includegraphics[height=0.4\textheight,width=\textwidth]{/testlaeufe/rechtskurve/auvroute.jpg}}}\\
\subfloat[Fehler der AUV Position zur echten Position des Objektes.]{\includegraphics[height=0.3\textheight,width=0.5\textwidth]{/testlaeufe/rechtskurve/groundTruthPosition.jpg}}&
\subfloat[Fehler der detektierten Objektposition zur echten Objektposition.]{\includegraphics[height=0.3\textheight,width=0.5\textwidth]{/testlaeufe/rechtskurve/groundTruth.jpg}}
\end{tabular}
...
\begin{figure}[H]
\begin{tabular}{cc}
\multicolumn{2}{c}{\subfloat[Fahrtverlauf (rot) bei einer Sinuskurve (blau).]{\includegraphics[height=0.4\textheight,width=\textwidth]{/testlaeufe/sinusGut/auvroute.jpg}}}\\
\subfloat[Fehler der AUV Position zur echten Position des Objektes.]{\includegraphics[height=0.3\textheight,width=0.5\textwidth]{/testlaeufe/sinusGut/groundTruthPosition.jpg}}&
\subfloat[Fehler der detektierten Objektposition zur echten Objektposition.]{\includegraphics[height=0.3\textheight,width=0.5\textwidth]{/testlaeufe/sinusGut/groundTruth.jpg}}
\end{tabular}
...
Außerdem wurde noch eine Kurve nach einer langen Geraden erzeugt. Hiermit wird getestet, ob auch wechselnden geometrischen Strukturen gefolgt werden kann.\todo{fehlt noch}
...
\begin{figure}[H]
\begin{tabular}{cc}
\multicolumn{2}{c}{\subfloat[Fahrtverlauf (rot) bei einer Kreisbahn mit geraden Abschnitten (blau).]{\includegraphics[height=0.4\textheight,width=\textwidth]{/testlaeufe/gradekreis/auvroute.jpg}}}\\
\subfloat[Fehler der AUV Position zur echten Position des Objektes.]{\includegraphics[height=0.3\textheight,width=0.5\textwidth]{/testlaeufe/gradekreis/groundTruthPosition.jpg}}&
\subfloat[Fehler der detektierten Objektposition zur echten Objektposition.]{\includegraphics[height=0.3\textheight,width=0.5\textwidth]{/testlaeufe/gradekreis/groundTruth.jpg}}
\end{tabular}
