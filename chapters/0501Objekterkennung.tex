...
Aus den Tests geht hervor, dass die Sichtbedingungen einen Einfluss auf die Binärisierung des Eingabebildes auswirkt. Je schlechter die Sichtbedingungen sind, desto geringer muss der Templateschwellwert gewählt werden. Der Schwellwert ist jedoch ausschlaggebend für die Qualität der Abbildung vom Objekt im Binärbild. Umso geringer der Schwellwert gewählt wird, umso mehr Störpunkte sind auch im Binärbild vorhanden. Bei schlechten Bedingungen muss der Schwellwert jedoch gering gewählt werden, um das Objekt abbilden zu können. Somit steigt bei schlechteren Sichtbedingungen die Gefahr falsche Detektionen aufgrund von Störpunkten zu erhalten oder auch Objekte zu detektieren, wo keine vorhanden sind.
...
\subfloat[]{\includegraphics[width=0.5\textwidth,height=0.2\textheight]{/imageProcessing/gradeTestQuali.jpg}}&
...
\subfloat[Objekt unter sehr schlechteren Sichtbedingungen]{\includegraphics[width=0.5\textwidth,height=0.2\textheight]{/imageProcessing/gradeschlecht.jpg}}&
\subfloat[Detektiertes Objekt unter sehr schlechteren Sichtbedingungen]{\includegraphics[width=0.5\textwidth,height=0.2\textheight]{/imageProcessing/gradeschlechtfin.jpg}}
\end{tabular}
...
\subfloat[Objekt unter sehr schlechteren Sichtbedingungen]{\includegraphics[width=0.5\textwidth,height=0.2\textheight]{/imageProcessing/gradeverborgenschlecht.jpg}}&
\subfloat[Detektiertes Objekt im ursprünglichen Simulationsbild]{\includegraphics[width=0.5\textwidth,height=0.2\textheight]{/imageProcessing/gradeverborgenschlechtfin.jpg}}
\end{tabular}
...
\subfloat[Objekt unter sehr schlechteren Sichtbedingungen]{\includegraphics[width=0.5\textwidth,height=0.2\textheight]{/imageProcessing/knickschlecht.jpg}}&
\subfloat[Detektiertes Objekt unter sehr schlechteren Sichtbedingungen]{\includegraphics[width=0.5\textwidth,height=0.2\textheight]{/imageProcessing/knickschlechtfin.jpg}}
\end{tabular}
...
\subfloat[Detektiertes Objekt im ursprünglichen Simulationsbild]{\includegraphics[width=0.5\textwidth,height=0.2\textheight]{/imageProcessing/nichtsoptimalfin.jpg}}\\
...
\subfloat[Detektiertes Objekt unter schlechteren Sichtbedingungen]{\includegraphics[width=0.5\textwidth,height=0.2\textheight]{/imageProcessing/nichtsTestQualiFin.jpg}}\\
...
\subfloat[Detektiertes Objekt unter sehr schlechteren Sichtbedingungen]{\includegraphics[width=0.5\textwidth,height=0.2\textheight]{/imageProcessing/nichtsschlechtfin.jpg}}
\end{tabular}
