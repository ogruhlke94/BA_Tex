...
\begin{figure}[H]
\begin{tabular}{cc}
\subfloat[Fahrtverlauf des AUVs (rot) an einer scharfen Kurve (blau)]{\includegraphics[height=0.4\textheight,width=0.5\textwidth]{/testlaeufe/kurvenichtverloren/auvroute.jpg}}&
\subfloat[Fahrtverlauf des AUVs (rot) an einer scharfen Kurve (blau)]{\includegraphics[height=0.4\textheight,width=0.5\textwidth]{/testlaeufe/kurveverloren/auvroute.jpg}}\\
...
\todo{hier fehlgeschlagene tests}
