...
Die Rotation wird durch die Ausrichtung des AUVs in der Welt (Yaw [Abbildung \ref{Abb. 2}]) bestimmt. Somit ergibt sich die Tranformationsmatrix \ref{trans_body_world}\\
...
Für die Transformation von Weltkoordinaten in VRML Koordinaten ist nur eine Rotation um $-90^\circ$ um die X-Achse nötig [Abbildung \ref{trans_world_vrml}].
\begin{ownequation}[H]
\begin{equation}
\begin{pmatrix}
