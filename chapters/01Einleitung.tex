...
Ein mögliches Beispiel hierfür ist ein Missionsszenario, in dem ein \gls{auv} einem Objekt am Meeresboden autonom folgen soll. So können Strukturen (Kabel, Pipelines etc.) von einem \gls{auv}\glsadd{auv} untersucht werden, ohne dass ein Pilot das Fahrzeug steuern und überwachen muss.\\
