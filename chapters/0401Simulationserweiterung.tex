...
\subfloat[Sichtverhältnisse verschlechtert]{\includegraphics[scale=0.8,width=0.33\textwidth]{/imageProcessing/Prinzip/sim2,5Vis.jpg}}&
\subfloat[Sichtverhältnisse stark verschlechtert]{\includegraphics[scale=0.8,width=0.33\textwidth]{/imageProcessing//Prinzip/sim2Vis.jpg}}&
\subfloat[Sichtverhältnisse sehr stark verschlechtert und simulierte Reflexion des Wassers]{\includegraphics[scale=0.8,width=0.33\textwidth]{/imageProcessing//Prinzip/sim2VisVielBlur.jpg}}
\end{tabular}
