...
\caption[Schätzung einer Objektbewegung mit Kalman-Filter.]{Eine Objektbewegung wird mit einem Kalman-Filter verfolgt. In schwarz ist der tatsächliche Objektverlauf gekennzeichnet. In grün ist ein Referenz-Tracking angegeben, dass ausschließlich auf der Objekterkennung basiert. Die verrauschten Messdaten sind in lila markiert.}
\label{kalmanFilter}
\end{figure}
