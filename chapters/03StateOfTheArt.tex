...
Underwater Images} Unterwasserpipelines mithilfe eines neuronalen Netzes. In Abbildung \ref{nnDet} ist zu sehen, dass die Pipelines sehr gut erkannt wurden. Selbst bei vom Sand verdeckte Pipeline (c und d) werden die Kanten der Pipelines noch richtig bestimmt.

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.3\textheight]{SOTA/nnpiperesults.jpg}
\caption[Pipelinedetektion mit neuronalem Netzwerk.]{Pipelines erkannt mithilfe eines neuronalen Netzwerks}
\label{nnDet}
\end{figure}
...
\caption[Schätzung eine Objektbewegung mit Kalman-Filter.]{Eine Objektbewegung wird mit einem Kalman-Filter verfolgt}
\label{kalmanFilter}
\end{figure}
